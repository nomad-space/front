...
<style lang="scss">
  ...
  @import "./assets/css/Lora.css";
  @import "./assets/css/Raleway_100.css";
  @import "./assets/css/Raleway_400.css";
  @import "./assets/css/PT_Sans.css";
  ...
  /*.menu-btn {float:right; display:none; width:12px; height:10px; background:url(./assets/img/menu-btn.png) right top no-repeat; margin:4px 23px 0px 0px;}*/
  ...
  /*.header-phone span {background:url(./assets/img/icon-phone.png) left top no-repeat; background-position:left 1px; padding:1px 0px 0px 25px;font-size:11px;color:#fff;font-family: 'Montserrat', sans-serif; font-weight:700;display:inline-block;min-height:15px;}*/
  ...
  /*.header-social .social-twitter {background:url(./assets/img/head-twitter.png) left top no-repeat;margin-left:0px;}*/
  /*.header-social .social-facebook {background:url(./assets/img/head-facebook.png) left top no-repeat;}*/
  /*.header-social .social-vimeo {background:url(./assets/img/head-vimeo.png) left top no-repeat;}*/
  /*.header-social .social-pinterest {background:url(./assets/img/head-pinterest.png) left top no-repeat;}*/
  /*.header-social .social-instagram {background:url(./assets/img/head-instargam.png) left top no-repeat;margin-right:0px;}*/
  ...
  /*.header-lang  a.langs-item.en {background:url(./assets/img/en.gif) left top no-repeat;}*/
  /*.header-lang  a.langs-item.fr {background:url(./assets/img/fr.gif) left top no-repeat;}*/
  /*.header-lang  a.langs-item.de {background:url(./assets/img/de.gif) left top no-repeat;}*/
  /*.header-lang  a.langs-item.it {background:url(./assets/img/it.gif) left top no-repeat;}*/
  ...
  /*.srch-close {display:block;width:13px;height:13px;float:right;margin:3px 0px 0px 0px;background:url(./assets/img/srch-close.png) left top no-repeat;}*/
  /*.hdr-srch-btn {display:block;width:13px;height:13px;background:url(./assets/img/srch-icon.png) left top no-repeat;}*/
  .hdr-srch-btn:hover {background-position:left -13px;}
  .mp-slider {position:relative;padding:130px 0px 0px 0px;}
  /*.mp-slider .arrow-left {display:block;position:absolute;left:45px;top:50%;margin-top:-16px;z-index:99;width:17px; height:31px;background:url(./assets/img/swipe-l.png) left top no-repeat;}*/
  /*.mp-slider .arrow-right {display:block;position:absolute;right:45px;top:50%;margin-top:-16px;z-index:99;width:17px; height:31px;background:url(./assets/img/swipe-r.png) left top no-repeat;}*/
  ...
  /*.search-select select {background-color: #fff;cursor:pointer;background-image: url(./assets/img/select-bg.gif);background-position: 80% center;background-repeat: no-repeat;border: 0px;border-radius: 0;font-size:11px;padding:7px 0px 8px 4px;outline: medium none;width: 117%;-webkit-appearance:none;-o-appearance:none;-khtml-appearance:none;appearance:none;text-transform:uppercase;font-family:'Raleway';color:#8a8a8a;}*/
  /*.search-select.full-width {border:1px solid #e3e3e3;background:#fff;font-size:11px;width:300px;background:url(./assets/img/select-bg.gif) right center no-repeat;border-radius:3px;}*/
  .search-select.full-width  select,
  .search-select.full-width-a select,
  .search-select.full-width-b select,
    /*.search-select.full-width-c select {background-color: #fff;cursor:pointer;background-image: url(./assets/img/select-bg.gif);background-position: 94.3% center;background-repeat: no-repeat;border: medium none;border-radius: 0;color: #d3d3d3;font-size:11px;padding:7px 0px 8px 4px;outline: medium none;width: 105%;text-transform:uppercase;font-family:'Raleway';font-weight:600;color:#8a8a8a;}*/
    /*.search-select.middle-c {border:1px solid #d6d6d6;background:#fff;font-size:11px;width:149px;background:url(./assets/img/select-bg.gif) right center no-repeat;border-radius:3px;}*/
  .full-width-search .search-line-a.last {margin-right:0px;}
  /*.search-select.full-width-a {border:1px solid #e3e3e3;background:#fff;font-size:11px;width:341px;background:url(./assets/img/select-bg.gif) right center no-repeat;border-radius:3px;}*/
  /*.search-select.full-width-b {border:1px solid #e3e3e3;background:#fff;font-size:11px;width:321px;background:url(./assets/img/select-bg.gif) right center no-repeat;border-radius:3px;}*/
  /*.search-select.full-width-c {border:1px solid #e3e3e3;background:#fff;font-size:11px;width:321px;margin-right:18px;background:url(./assets/img/select-bg.gif) right center no-repeat;border-radius:3px;}*/
  .search-line-select.middle-b {width:auto;float:left;margin-right:0px;margin-left:18px;}
  /*.search-select.half-width  select {background-color: #fff;cursor:pointer;background-image: url(./assets/img/select-bg.gif);background-position: 89% center;background-repeat: no-repeat;border: medium none;border-radius: 0;color: #d3d3d3;font-size:11px;padding:7px 0px 8px 4px;outline: medium none;width: 110%;text-transform:uppercase;font-family:'Raleway';font-weight:600;color:#8a8a8a;}*/
  ...
  /*.autorize-close {display:block;width:39px;height:39px;float:right;background:url(./assets/img/popup-close.png) left top no-repeat;}*/
  ...
  .weather-block {
    width:345px;
    height:344px;
    /*background:url(./assets/img/paris.jpg) left top no-repeat;*/
  ...
  /*.date-icon {display:block; width:16px; height:15px; background:url(./assets/img/datepick.png) left top no-repeat; position:absolute; z-index:1; top:7px; right:8px;}*/
  ...
  .mp-popular header b,.page-lbl b,.offer-slider-lbl {
    ...
    /*background:url(./assets/img/pop-hdr.png) center bottom no-repeat;*/
  }
  ...
  /*.catalog-head .search-select select {background-image: url("./assets/img/select-bg2.png"); padding-top: 9px; padding-bottom: 8px; font-size: 9px; color:#8a8a8a; background-position: 80% center; background-repeat: no-repeat;}*/
  .show-thumbs,.show-table,.show-list {margin-left: 5px; display: block; width: 29px; height: 29px; float: right;}
  /*.show-thumbs {background: url(./assets/img/sort-a.png) left top no-repeat;}*/
  /*.show-table {background: url(./assets/img/sort-b.png) left top no-repeat;}*/
  /*.show-list {background: url(./assets/img/sort-c.png) left top no-repeat;}*/
  .show-thumbs.chosen,
  .show-table.chosen,
  ...
  /*.cat-icon-01 {display: block; float: left; width:15px; height:13px; background: url(./assets/img/cat-icon-01.png) left top no-repeat;}*/
  /*.cat-icon-02 {display: block; float: left; width:9px; height:13px; background: url(./assets/img/cat-icon-02.png) left top no-repeat;}*/
  /*.cat-icon-03 {display: block; float: left; width:11px; height:13px; background: url(./assets/img/cat-icon-03.png) left top no-repeat;}*/
  /*.cat-icon-04 {display: block; float: left; width:11px; height:13px; background: url(./assets/img/cat-icon-04.png) left top no-repeat;}*/
  /*.cat-icon-05 {display: block; float: left; width:11px; height:13px; background: url(./assets/img/cat-icon-05.png) left top no-repeat;}*/
  /*.cat-icon-06 {display: block; float: left; width:7px; height:13px; background: url(./assets/img/cat-icon-06.png) left top no-repeat;}*/
  ...
  .offer-slider-overlay {
    ...
    left:0px;
    top:0px;
    /*background:url(./assets/img/offer-over.png) left top repeat;*/
  }
  .offer-slider-btn {
    font-family: 'Raleway';
    font-weight:600;
  ...
  .testimonials-holder .bx-prev {
    /*background:url(./assets/img/test-l.gif) left top no-repeat;*/
    left:0px;
  }
  .testimonials-holder .bx-next {
    /*background:url(./assets/img/test-r.gif) left top no-repeat;*/
    right:0px;
  }
  ...
  .offer-slider-c .owl-prev {
    /*background:url(./assets/img/offers-l.png) left top no-repeat;*/
    left:-45px;
  }
  .offer-slider-c .owl-next {
    /*background:url(./assets/img/offers-r.png) left top no-repeat;*/
    right:-45px;
  }
  ...
  /*.regions-holder .asia {background:url(./assets/img/asia.png) left top no-repeat;}*/
  /*.regions-holder .africa {background:url(./assets/img/africa.png) left top no-repeat;}*/
  /*.regions-holder .austalia {background:url(./assets/img/australia.png) left top no-repeat;}*/
  /*.regions-holder .europe {background:url(./assets/img/europe.png) left top no-repeat;}*/
  /*.regions-holder .north-america {background:url(./assets/img/north-america.png) left top no-repeat;}*/
  /*.regions-holder .south-america {background:url(./assets/img/south-america.png) left top no-repeat;}*/
  .regions-holder area {cursor:pointer;}
  .regions-holder map {position:absolute; left:0px; top:0px;z-index:9999;}
  /*.regions-nav ul li {display:inline-block;background:url(./assets/img/regions-nav.png) right top no-repeat;padding:0px 9px 4px 0px;margin:0px 0px 0px 2px;background-position:right 7px;}*/
  ...
  /*.reasons-item-a {width:286px;float:left;background:url(./assets/img/reasons-01.png) left top no-repeat;padding:6px 0px 0px 63px;margin:0px 0px 26px 0px;}*/
  /*.reasons-item-b {width:286px;float:right;background:url(./assets/img/reasons-02.png) left top no-repeat;padding:6px 0px 0px 63px;margin:0px 0px 26px 0px;	}*/
  /*.reasons-item-c {width:286px;float:left;background:url(./assets/img/reasons-03.png) left top no-repeat;padding:6px 0px 0px 63px;}*/
  /*.reasons-item-d {width:286px;float:right;background:url(./assets/img/reasons-04.png) left top no-repeat;padding:6px 0px 0px 63px;}*/
  .reasons-lbl {
    font-size:14px;
    color:#3a4142;
    /*background:url(./assets/img/reasons-lbl.gif) left bottom no-repeat;*/
    font-family: 'Montserrat';
    font-weight:normal;
    margin-bottom:10px;
  ...
  .tweet {
    margin-bottom:17px;
    /*background:url(./assets/img/icon-tweet.png) left top no-repeat;*/
  ...
  .footer-subscribe-a {
    /*background:url(./assets/img/icon-subscribe.png) left top no-repeat;*/
    min-height:11px;
  ...
  .footer-social a.footer-twitter {
    /*background:url(./assets/img/footer-twitter.png) left top no-repeat;*/
  }
  .footer-social a.footer-facebook {
    /*background:url(./assets/img/footer-facebook.png) left top no-repeat;*/
  }
  .footer-social a.footer-vimeo {
    /*background:url(./assets/img/footer-vimeo.png) left top no-repeat;*/
  }
  .footer-social a.footer-pinterest {
    /*background:url(./assets/img/footer-pinterest.png) left top no-repeat;*/
  }
  .footer-social a.footer-instagram {
    /*background:url(./assets/img/footer-instagram.png) left top no-repeat;*/
  }
  ...
  /*.testimonials-flat {padding:150px 0px 0px 0px;width:100%;height:350px;margin:0px 0px 93px 0px;background:url(./assets/img/testimonials-s.jpg) center top no-repeat;}*/
  /*.testimonials-flat.about-ts {background:url(./assets/img/about-ts.jpg) left top no-repeat;}*/
  .testimonials-flat .testimonials-b,.testimonials-flat .testimonials-d {color:#fff;	}
  /*.testimonials-flat .testimonials-holder .bx-prev {background:url(./assets/img/ss-l.png) left top no-repeat;height:21px;width:12px;}*/
  /*.testimonials-flat .testimonials-holder .bx-next {background:url(./assets/img/ss-r.png) left top no-repeat;height:21px;width:12px;}*/
  ...
  /*.theme-teaser {width:100%; height:500px; margin-bottom:93px; background:url(./assets/img/theme-teaser.jpg) center top no-repeat;}*/
  ...
  /*.srch-results-lbl span {display: block; height:15px; background: url(./assets/img/result-icon.png) left top no-repeat; background-position: left 2px; padding: 0px 0px 0px 28px ;}*/
  ...
  /*.side-block .jq-checkbox.checked span {width:10px; height:8px; left:2px; bottom:4px; margin:0px; box-shadow:none; background: transparent url(./assets/img/checkbox.png) left top no-repeat; position: absolute;}*/
  ...
  /*.checkbox .jq-checkbox.checked span {width:10px; height:8px; left:2px; bottom:4px; margin:0px; box-shadow:none; background: transparent url(./assets/img/checkbox.png) left top no-repeat; position: absolute;}*/
  ...
  /*.fancybox-close {width:10px; height:10px; background:url(./assets/img/colorbox-close.png) left top no-repeat; bottom:-20px; right:14px; top:auto;}*/
  /*.fancybox-prev span {display:block; width:10px; height:16px; left:-40px; background:url(./assets/img/colorbox-left.png) left top no-repeat; visibility:visible;}*/
  /*.fancybox-next span {display:block; width:10px; height:16px; right:-40px; background:url(./assets/img/colorbox-right.png) left top no-repeat; visibility:visible;}*/
  ...
  /*.way-lbl {margin-bottom: 23px; margin-top: 5px; text-transform: uppercase; font-size: 12px; color:#8a8a8a; font-family: 'Raleway'; display: inline-block; padding-right: 27px; font-weight: 500; background: url(./assets/img/depart-icon.png) right top no-repeat; background-position: right 1px;}*/
  /*.flt-i-bb.flight-return .way-lbl {background:url(./assets/img/return-icon.png) right top no-repeat; padding-right:48px; background-position: right 1px;}*/
  ...
  /*.flight-line-d {display: inline-block; vertical-align: middle; width:4px; height:7px; background: url(./assets/img/flt-devider.png) left top no-repeat; margin: 0px 11px 0px 13px;}*/
  .flight-line-b {float: right; margin-top: -3px;  line-height: 16px;}
  /*.flight-line-b b {cursor: pointer; display: block; background: url(./assets/img/details-icon.png) right top no-repeat; background-position: right 6px; font-size: 11px; font-family: 'Open Sans'; font-weight: normal; text-transform: uppercase; font-weight: 600; color:#4d4d4d;}*/
  /*.flight-line-b b.open {cursor: pointer; display: block; background: url(./assets/img/details-icon-up.png) right top no-repeat; background-position: right 6px; font-size: 11px; font-family: 'Open Sans'; font-weight: normal; text-transform: uppercase; font-weight: 600;}*/
  ...
  /*.alt-departure {background:url(./assets/img/alt-depart.png) left center no-repeat; margin-right:26px; padding:0px 0px 0px 23px;}*/
  /*.alt-arrival {background:url(./assets/img/alt-return.png) left center no-repeat; margin-right:27px; padding:0px 0px 0px 23px;}*/
  /*.alt-time {background:url(./assets/img/alt-time.png) left center no-repeat; margin-right:20px; padding:0px 0px 0px 23px;}*/
  ...
  /*.preloader { background:url(./assets/img/89.gif) center center no-repeat #ffffff;  }*/
  ...
  .tour-duration {float:left; font-size:12px; margin:4px 0px 0px 33px; color:#747d7e; font-family:'Raleway'; font-weight:600; text-transform:uppercase;}
  ...
  /*.h-help-phone {font-family:'Open Sans'; font-size:20px; color:#4a90a4; background:url(./assets/img/h-phone.png) left top no-repeat; padding:0px 0px 0px 23px; background-position:left 5px;}*/
  ...
  /*.h-add-review {text-decoration:none; margin:2px 0px 0px 0px; float:right; background:url(./assets/img/add.png) left top no-repeat; padding:0px 0px 0px 17px; background-position:left 0px; text-transform:uppercase; font-size:11px; color:#747d7e;}*/
  ...
  /*.h-tabs-right i {float:left; display:block; width:15px; height:15px; background:url(./assets/img/more-icon.png) left top no-repeat;}*/
  ...
  /*.h-tab-item-01 i {display:block;  background:url(./assets/img/gall-icon.png) left top no-repeat; float:left; width:17px; height:16px;}*/
  /*.h-tab-item-02 i {display:block;  background:url(./assets/img/map-icon.png) left top no-repeat; float:left; width:13px; height:16px;}*/
  /*.h-tab-item-03 i {display:block;  background:url(./assets/img/calc-icon.png) left top no-repeat; float:left; width:17px; height:16px;}*/
  ...
  /*.wishlist-btn-l i {display:block; background:url(./assets/img/whishlist.png) left top no-repeat; float:left; margin:16px 0px 0px 15px; width:10px; height:10px;}*/
  ...
  /*.book-btn-l i {display:block; background:url(./assets/img/book-icon.png) left top no-repeat; float:left; margin:17px 0px 0px 14px; width:12px; height:8px;}*/
  ...
  /*.tab-gallery-preview .bx-prev {left:0px; background:url(./assets/img/gall-prev.png) left top no-repeat;}*/
  /*.tab-gallery-preview .bx-next {right:0px; background:url(./assets/img/gall-next.png) left top no-repeat;}*/
  .tab-gallery-preview .bx-prev:hover,.tab-gallery-preview .bx-next:hover {background-position:left -75px;}
  /*.tabs-lamp {background:url(./assets/img/icon-lamp.png) left top no-repeat; float:right; width:40px; height:42px; display:block;}*/
  ...
  /*.content-tabs-head.last-item ul li:last-child a {margin: 0px; padding: 0px ; background: #ede9e6 url(./assets/img/icon-lamp.png) left top no-repeat; float:right; width:40px; height:42px; display:block;}*/
  ...
  /*.content-tabs-head.last-item ul li:last-child a.active {background: #fff url(./assets/img/icon-lamp.png) left top no-repeat; background-position: left -42px;}*/
  ...
  /*.tab-reasons-i.reasons-01 {background:url(./assets/img/tabs-i-01.png) left top no-repeat;}*/
  /*.tab-reasons-i.reasons-02 {background:url(./assets/img/tabs-i-02.png) left top no-repeat;}*/
  /*.tab-reasons-i.reasons-03 {background:url(./assets/img/tabs-i-03.png) left top no-repeat;}*/
  /*.tab-reasons-i.reasons-04 {background:url(./assets/img/tabs-i-04.png) left top no-repeat;}*/
  ...
  /*.facility-label {background:url(./assets/img/free-icon.png) left top no-repeat; padding:0px 0px 0px 14px; background-position:left 4px;}*/
  ...
  /*.rates-srch {display:block; float:right; margin:21px 0px 0px 0px; width:34px; height:34px; background:#ff7200 url(./assets/img/rates-srch.png) left top no-repeat; border-radius:2px; border:0px; cursor:pointer;}*/
  /*.rates-srch:hover {background:#ff8f35 url(./assets/img/rates-srch.png) left top no-repeat;}*/
  ...
  /*.preferences-list li.internet {background:url(./assets/img/pref-01.png) left top no-repeat;}*/
  /*.preferences-list li.conf-room {background:url(./assets/img/pref-02.png) left top no-repeat;}*/
  /*.preferences-list li.play-place {background:url(./assets/img/pref-03.png) left top no-repeat;}*/
  /*.preferences-list li.restourant {background:url(./assets/img/pref-04.png) left top no-repeat;}*/
  /*.preferences-list li.bar {background:url(./assets/img/pref-05.png) left top no-repeat;}*/
  /*.preferences-list li.doorman {background:url(./assets/img/pref-06.png) left top no-repeat;}*/
  /*.preferences-list li.kitchen {background:url(./assets/img/pref-07.png) left top no-repeat;}*/
  /*.preferences-list li.spa {background:url(./assets/img/pref-08.png) left top no-repeat;}*/
  /*.preferences-list li.bike {background:url(./assets/img/pref-09.png) left top no-repeat;}*/
  /*.preferences-list li.entertaiment {background:url(./assets/img/pref-10.png) left top no-repeat;}*/
  /*.preferences-list li.hot-tub {background:url(./assets/img/pref-11.png) left top no-repeat;}*/
  /*.preferences-list li.pool {background:url(./assets/img/pref-12.png) left top no-repeat;}*/
  /*.preferences-list li.parking {background:url(./assets/img/pref-13.png) left top no-repeat;}*/
  /*.preferences-list li.gym {background:url(./assets/img/pref-14.png) left top no-repeat;}*/
  /*.preferences-list li.tv {background:url(./assets/img/pref-15.png) left top no-repeat;}*/
  /*.preferences-list li.pets {background:url(./assets/img/pref-16.png) left top no-repeat;}*/
  /*.preferences-list li.handicap {background:url(./assets/img/pref-17.png) left top no-repeat;}*/
  /*.preferences-list li.secure {background:url(./assets/img/pref-18.png) left top no-repeat;}*/
  ...
  /*.preferences-list-alt li.internet {background:url(./assets/img/pref-alt-01.png) left top no-repeat;}*/
  /*.preferences-list-alt li.parking {background:url(./assets/img/pref-alt-02.png) left top no-repeat;}*/
  /*.preferences-list-alt li.gym {background:url(./assets/img/pref-alt-03.png) left top no-repeat;}*/
  /*.preferences-list-alt li.restourant {background:url(./assets/img/pref-alt-04.png) left top no-repeat;}*/
  /*.preferences-list-alt li.pets {background:url(./assets/img/pref-alt-05.png) left top no-repeat;}*/
  /*.preferences-list-alt li.pool {background:url(./assets/img/pref-alt-06.png) left top no-repeat;}*/
  /*.preferences-list-alt li.kitchen {background:url(./assets/img/pref-alt-07.png) left top no-repeat;}*/
  /*.preferences-list-alt li.conf-room {background:url(./assets/img/pref-alt-08.png) left top no-repeat;}*/
  /*.preferences-list-alt li.bike {background:url(./assets/img/pref-alt-09.png) left top no-repeat;}*/
  /*.preferences-list-alt li.entertaiment {background:url(./assets/img/pref-alt-10.png) left top no-repeat;}*/
  /*.preferences-list-alt li.bar {background:url(./assets/img/pref-alt-11.png) left top no-repeat;}*/
  /*.preferences-list-alt li.secure {background:url(./assets/img/pref-alt-12.png) left top no-repeat;}*/
  ...
  */
  ...
  /*.review-form .customSelect {padding:8px 7px 8px 7px; margin-bottom: 24px; cursor: pointer; border: 1px solid #dedcdc; background: url(./assets/img/custom-select.png) right top no-repeat; cursor: pointer !important; width:63%; border-radius: 2px;}*/
  ...
  /*.faq-item-i {float: right; margin-top: 2px; display: block; width:12px; height:12px; background: url(./assets/img/faq.png) left top no-repeat;}*/
  ...
  /*.calendar-tab-select .customSelect  {border-radius:2px; margin-bottom:17px; background:url(./assets/img/tab-select.png) right top no-repeat; width:257px; height:25px; padding:7px 0px 0px 9px; border:1px solid #dedcdc;}*/
  ...
  /*.card-expiration .customSelect {width:100%; padding:7px 0px 7px 0px; border:1px solid #e3e3e3; background:url(./assets/img/card-select.png) right top no-repeat; -webkit-box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05);-moz-box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05); box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05); border-radius:2px;}*/
  ...
  /*.payment-alert span {background:url(./assets/img/alert-info.png) left top no-repeat; padding:1px 0px 0px 17px; background-position:left 2px;}*/
  ...
  /*.comlete-alert-a {background:url(./assets/img/icon-complete.png) left top no-repeat; background-position:left 4px; padding:0px 0px 0px 40px;}*/
  ...
  /*.tour-icon-person {float:left; font-weight:600; font-size:11px; color:#747d7e; text-transform:uppercase; padding:0px 0px 0px 25px; margin:0px 0px 0px 22px; font-family:'Raleway'; background:url(./assets/img/persons-icon.png) left top no-repeat;}*/
  ...
  /*.form-calendar-a .customSelect {width:100%; padding:7px 0px 7px 0px; border:1px solid #e3e3e3; background:url(./assets/img/card-select.png) right top no-repeat; -webkit-box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05);-moz-box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05); box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05); border-radius:2px;}*/
  ...
  /*.form-calendar-b .customSelect {width:100%; padding:7px 0px 7px 0px; border:1px solid #e3e3e3; background:url(./assets/img/card-select.png) right top no-repeat; -webkit-box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05);-moz-box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05); box-shadow: 0px 1px 1px 0px rgba(50, 50, 50, 0.05); border-radius:2px;}*/
  ...
  /*.add-passanger {font-size:12px; color:#848484; font-weight:500; text-decoration:none; margin:4px 0px 0px 0px; padding:0px 0px 0px 14px; float:right; background:url(./assets/img/add-pass-icon.png) left top no-repeat; background-position:left 2px;}*/
  ...
  /*.side-social a.side-social-twitter {background: url(./assets/img/left-social-01.png) left top no-repeat;}*/
  /*.side-social a.side-social-facebook {background: url(./assets/img/left-social-02.png) left top no-repeat;}*/
  /*.side-social a.side-social-vimeo {background: url(./assets/img/left-social-03.png) left top no-repeat;}*/
  /*.side-social a.side-social-pinterest {background: url(./assets/img/left-social-04.png) left top no-repeat;}*/
  /*.side-social a.side-social-instagram {background: url(./assets/img/left-social-05.png) left top no-repeat;}*/
  ...
  /*.about-slider-h.styled {height:280px; padding:80px 0px 0px 0px; background:url(./assets/img/about-styled.jpg) center top no-repeat;}*/
  ...
  /*.team-fb {display:inline-block; background:url(./assets/img/about-facebook.png) left top no-repeat; width:8px; height:13px;}*/
  /*.team-tw {display:inline-block; background:url(./assets/img/about-twitter.png) left top no-repeat; width:13px; height:13px;}*/
  /*.team-gp {display:inline-block; background:url(./assets/img/about-gp.png) left top no-repeat; width:13px; height:13px;}*/
  /*.team-inst {display:inline-block; background:url(./assets/img/about-insta.png) left top no-repeat; width:11px; height:13px;}*/
  /*.team-pint {display:inline-block; background:url(./assets/img/about-pinterest.png) left top no-repeat; width:10px; height:13px;}*/
  /*.team-vk {display:inline-block; background:url(./assets/img/about-vk.png) left top no-repeat; width:15px; height:13px;}*/
  ...
  /*.solution-icon {display:inline-block; width:16px; height:10px; background:url(./assets/img/icon-solution.png) left top no-repeat;}*/
  ...
  /*.solution-icon-a {display:block; background:url(./assets/img/solutions-i-a.png) left top no-repeat; position:absolute; left:50%; margin-left:-4px; bottom:18px; z-index:999; width:8px; height:8px;}*/
  ...
  /*.portfolio-zoom {display:inline-block; background:url(./assets/img/portfolio-zoom.png) left top no-repeat; margin-right:1px; width:38px; height:38px;}*/
  /*.portfolio-more {display:inline-block; background:url(./assets/img/portfolio-more.png) left top no-repeat; margin-left:1px; width:38px; height:38px;}*/
  ...
  /*.p-item-padding .bx-prev {background:url(./assets/img/p-slider-l.png) left top no-repeat; left:21px;}*/
  /*.p-item-padding .bx-next {background:url(./assets/img/p-slider-r.png) left top no-repeat; right:21px;}*/
  ...
  /*.portfolio-nav-l a {display:inline-block; background:url(./assets/img/portfolio-l.png) left top no-repeat; width:36px; height:36px;}*/
  /*.portfolio-nav-r a {display:inline-block; background:url(./assets/img/portfolio-r.png) left top no-repeat; width:36px; height:36px;}*/
  .portfolio-nav-l a:hover,.portfolio-nav-r a:hover {background-position:left -36px;}
  /*.portfolio-nav-c a {display:inline-block; opacity:0.6; background:url(./assets/img/portfolio-all.png) left top no-repeat; width:19px; height:19px;}*/
  ...
  /*.blog-post-slider .bx-prev {background:url(./assets/img/p-slider-l.png) left top no-repeat; left:21px;}*/
  /*.blog-post-slider .bx-next {background:url(./assets/img/p-slider-r.png) left top no-repeat; right:21px;}*/
  ...
  /*.mejs-controls .mejs-play button {width:11px; height: 11px; margin-top: 10px; margin-left: 10px; background: url(./assets/img/btn-play.gif) left top no-repeat;}*/
  /*.mejs-controls .mejs-pause  button {background:url("./assets/img/pause.png") left top no-repeat !important; margin-left: 9px !important; margin-top:11px !important;}*/

  /*.mejs-controls .mejs-fullscreen-button button {margin-top: 10px; width:10px; height:10px; background: url(./assets/img/full-btn.png) left top no-repeat;}*/
  /*.mejs-controls .mejs-pause button {width:11px; height: 11px; margin-top: 10px; margin-left: 9px; background: url(./assets/img/btn-play.gif) left top no-repeat; background-position: 0 0;}*/
  ...
  /*.mejs-overlay-button {position: absolute; top: 50%; left: 50%; width: 36px; height: 36px; margin-left:-15px; margin-top:-15px !important; background: url(./assets/img/video-play.png) no-repeat;}*/
  /*.mejs-controls .mejs-mute button {margin-top: 11px; width:9px; height:10px; background: url(./assets/img/vol-btn.png) left top no-repeat;}*/
  /*.mejs-container {width:100% !important; height:30px;  -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px; background: transparent url(./assets/img/audio-bg.gif) left top repeat-x !important;}*/
  /*.mejs-overlay:hover .mejs-overlay-button {background: url(./assets/img/video-play.png) no-repeat; background-position: left 0px;}*/
  /*.mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-current {border-radius: 0px; background: url(./assets/img/v-current.png) left top repeat-x;}*/
  ...
  /*.mejs-controls .mejs-unmute button {margin-top: 11px; width:9px; height:10px; background: url(./assets/img/vol-btn.png) left top no-repeat; background-position: left 0 0;}*/
  ...
  /*.tweeter-item-l {width:12px; margin-top:8px; height:10px; background:url(./assets/img/tweeter-i.png) left top no-repeat; float:left;}*/
  ...
  /*.blog-masonry-preview .bx-prev {background:url(./assets/img/p-slider-l.png) left top no-repeat; left:14px;}*/
  /*.blog-masonry-preview .bx-next {background:url(./assets/img/p-slider-r.png) left top no-repeat; right:14px;}*/

  /*.blog-masonry-quote-a {font-size:16px; color:#414f51; padding:0px 0px 0px 26px; margin-bottom:9px; line-height:27px; background:url(./assets/img/quote-icon.png) left top no-repeat; background-position:left 7px;}*/
  ...
  /*.share-popup {background:url(./assets/img/share-popup.png) left top no-repeat; display:none; position:absolute; top:28px; right:3px; width:29px; height:79px; padding-top:10px;}*/
  ...
  /*.columns-block-lbl span {background:url(./assets/img/columns-bg.png) left bottom no-repeat; padding-bottom:18px; display:block;}*/
  ...
  /*.typography-heading {text-align:center; margin-bottom:35px; font-size:15px; color:#141d1e; font-weight:500; text-transform:uppercase; background:url("./assets/img/columns-bg.png") center bottom no-repeat; padding-bottom:17px;}*/
  ...
  /*.toggle-trigger {width:40px; height:40px; display:block; background:url(./assets/img/toggle.png) left top no-repeat;}*/
  ...
  /*.accordeon-icon {display:block; margin:3px 18px 0px 0px; background:url(./assets/img/accordeon-i.png) left top no-repeat; float:left; width:10px; height:10px;}*/
  ...
  /*.counters-five-colls b {background:url(./assets/img/counters-d.png) center bottom no-repeat; padding-bottom:9px; margin-bottom:9px;}*/
  ...
  /*.pie-charts-lbl {text-transform:uppercase; font-size:14px; margin-bottom:8px; color:#3a4142; font-weight:500; padding-bottom:11px; background:url(./assets/img/columns-bg.png) center bottom no-repeat;}*/
  ...
  @media screen and (max-width:910px) {
    ...
    @media screen and (max-width: 660px) {
      ...
      .tab-reasons-i.reasons-01 {
        /*background: url(./assets/img/tabs-i-01.png) center top no-repeat;*/
      }

      .tab-reasons-i.reasons-02 {
        /*background: url(./assets/img/tabs-i-02.png) center top no-repeat;*/
      }

      .tab-reasons-i.reasons-03 {
        /*background: url(./assets/img/tabs-i-03.png) center top no-repeat;*/
      }

      .tab-reasons-i.reasons-04 {
        /*background: url(./assets/img/tabs-i-04.png) center top no-repeat;*/
      }
