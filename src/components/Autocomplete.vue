...
<template>
  ...
  <div :class="classAutocomplete" :id="idAutocomplete" v-show="showList">
    <ul>
  ...
  export default {
    ...
    data() {
      return {
        ...
        json: [],
        focusList: "",
        classAutocomplete: "autocomplete transition autocomplete-"+name,
        idAutocomplete: "autocomplete-"+name
      };
    },
